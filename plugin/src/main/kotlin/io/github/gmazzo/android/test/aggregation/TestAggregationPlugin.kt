...
class TestAggregationPlugin : Plugin<Project> {

    companion object {

        val AGGREGATED_COVERAGE_ATTRIBUTE: Attribute<Boolean> =
            Attribute.of("com.android.coverage.aggregated", Boolean::class.javaObjectType)
    ...
    override fun apply(target: Project): Unit = with(target) {
        ...
        allprojects {
            ...
            plugins.withId("jacoco") {
                val childDependency =
                    (rootProject.dependencies.create(project) as ModuleDependency).attributes {
                        attribute(AGGREGATED_COVERAGE_ATTRIBUTE, true)
                    }
